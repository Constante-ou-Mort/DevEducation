namespace SpecflowTestProject
{
    public static class Context
    {
        ...
        public static string ChangedClientFirstNameAndLastNameResponseModel = "Changed First Name And Last Name Response Model";

        public static string ExpectedFirstNameAndLastName = "Expexted First Name And Last Name";
    }
}